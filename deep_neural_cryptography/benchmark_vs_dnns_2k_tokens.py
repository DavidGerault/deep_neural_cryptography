...
class Benchmark2KTokens:
    ...
    def measure_aes_performance(self, num_blocks: int, warmup_runs: int = 50, num_runs: int = 100) -> Dict:
        ...
        # Skip compilation for AES model due to compatibility issues
        compilation_success = False
        print("    Skipping AES model compilation (compatibility issues)")
        ...
        # Convert to tensor
        plaintext = torch.tensor(plaintext_bits, dtype=torch.float32).to(self.device)
